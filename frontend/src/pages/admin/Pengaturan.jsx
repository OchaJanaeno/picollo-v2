...
useEffect(() => {
  ...
  const inputCls = (f) =>
    `w-full border rounded-xl px-4 py-2.5 text-sm text-zinc-900 placeholder-zinc-400
     ...
     ${errors[f] ? 'border-red-400 bg-red-50' : 'border-zinc-200 focus:border-red-800'}`
            ...
            <div className="bg-white rounded-2xl border border-zinc-200 p-6 text-center">
              ...
              <div className="relative inline-block mb-4">
                <div
                  ...
                  {fotoPreview
                    ...
                    : <div className="w-full h-full bg-gradient-to-br from-red-800 to-red-600
              ...
              <div className="flex items-center justify-center gap-3 mb-2">
                <button onClick={() => fileRef.current?.click()}
                  className="text-xs font-semibold text-red-800 hover:text-red-900
                ...
                <div className="p-6">
                  ...
                  <form onSubmit={handleSaveProfile} className="space-y-4">
                    ...
                    <button type="submit" disabled={loadingProfile}
                      className="bg-zinc-900 hover:bg-red-900 disabled:bg-zinc-400
