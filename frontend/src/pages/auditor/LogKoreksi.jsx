            ...
            {['semua', 'edit', 'edit_items', 'void'].map(t => {
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded-xl text-xs font-semibold capitalize transition-all border duration-200 ${isActive ? activeClass : `bg-white text-zinc-500 border-zinc-200 ${hoverClass}`
                    }`}
                >
                ...
                {loading ? (
                  ...
                  <tr key={d.id} className="hover:bg-zinc-50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 whitespace-nowrap">
                      <span className={`text-xs font-semibold px-2.5 py-1 rounded-full capitalize ${d.tipe === 'void' ? 'bg-red-100 text-red-700' :
                    ...
                    <td
                      className="px-5 py-3.5 text-xs text-zinc-500 max-w-xs truncate"
                      title={d.alasan}
                    >
                      {d.alasan}
                    </td>
                    ...
                    <td className="px-5 py-3.5 whitespace-nowrap">
                      <div className="flex items-center gap-1.5">
                        <span
                          className={`text-xs font-semibold px-2.5 py-1 rounded-full ${d.disetujui
              ...
              <div className="bg-zinc-50 border border-zinc-150 rounded-2xl p-4">
                ...
                <div className="grid grid-cols-2 gap-y-3.5 gap-x-4 text-xs">
                  ...
                  <div>
                    ...
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold border ${detail.tipe === 'void' ? 'bg-red-50 text-red-700 border-red-100' :
                  ...
                  <div>
                    ...
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold ${detail.disetujui ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' : 'bg-amber-50 text-amber-700 border border-amber-100'
                      }`}>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded transition-all duration-200 ${copiedSebelum
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <button
                          ...
                          className={`inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded transition-all duration-200 ${copiedSesudah
                              ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/30'
                              : 'bg-zinc-800 hover:bg-zinc-700 text-zinc-300'
                            }`}
                        >
